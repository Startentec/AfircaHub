              ...
              <h3 style={{paddingLeft:"10px"}}>Update my account</h3>
                 <div className="resul">
                  ...
                  <div className="yourself">
                    <TextField id="outlined-multiline-static" color="grey"  label="Say something about this candidate"  multiline  maxRows={4}   style={{width:"100%"}} />
                  </div>

                  <div className="resul" style={{marginTop:"10px"}}>
                    <Grid container style={{gap:"10px"}}>
                      <Grid item xs={11} md={11} lg={6}  style={{width:"100%"}}>
                        <Button className="buttons" startIcon={<UpdateIcon fontSize="small"/>}  variant="contained" style={{backgroundColor: "rgb(63, 7, 7)", color:"white", width:"100%",fontSize:"11px !important"}} >Upload a pdf in docs/pdf</Button>
                      </Grid>
                      <Grid item xs={11} md={11} lg={3}>
                        <Button className="buttons" startIcon={<SearchIcon fontSize="small"/>}  variant="contained" style={{backgroundColor: "rgb(63, 7, 7)", color:"white"}} >Download your cv</Button>
                      </Grid>
                    </Grid>
                  </div>
